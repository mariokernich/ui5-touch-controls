...
/**
 * Constructor for a new <code>ui5.sized.controls.Example</code> control.
 *
 ...
 * @constructor
 * @public
 * @name ui5.sized.controls.Example
 */
export default class Example extends Control {
	...
	static readonly metadata: MetadataOptions = {
		...
		properties: {
			 ...
			 */
			color: {
				type: "ui5.sized.controls.ExampleColor",
				group: "Appearance",
